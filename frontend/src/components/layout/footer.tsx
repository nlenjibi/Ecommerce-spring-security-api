...
import { NewsletterSubscribe } from '../features/landing/NewsletterSubscribe';
        ...
        <div className="py-12">
          ...
          <div className="hidden md:grid grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2.5">
                <li>
                  <Link href="/marketing/help" className="text-gray-400 text-sm hover:text-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-500 rounded px-1 transition-colors duration-300">
                    Help Center
                  </Link>
                </li>
                <li>
                  <Link href="/marketing/contact" className="text-gray-400 text-sm hover:text-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-500 rounded px-1 transition-colors duration-300">
                    Contact Us
                  </Link>
                </li>
                <li>
                  <Link href="/marketing/faq" className="text-gray-400 text-sm hover:text-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-500 rounded px-1 transition-colors duration-300">
                    FAQ
                  </Link>
                </li>
                <li>
                  <Link href="/marketing/shipping" className="text-gray-400 text-sm hover:text-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-500 rounded px-1 transition-colors duration-300">
                    Shipping Info
                  </Link>
                </li>
                <li>
                  <Link href="/marketing/returns" className="text-gray-400 text-sm hover:text-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-500 rounded px-1 transition-colors duration-300">
                    Returns & Refunds
                  </Link>
                </li>
              </ul>
            ...
            <div>
              <Link href="/marketing/terms-of-service"> <h3 className="text-sm font-semibold text-white mb-4 uppercase tracking-wide">Newsletter</h3> </Link>
              ...
              <ul className="space-y-2">
                <li>
                  <Link href="/marketing/terms-of-service" className="text-gray-400 text-xs hover:text-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-500 rounded px-1 transition-colors duration-300">
                    Terms of Use
                  </Link>
                </li>
                <li>
                  <Link href="/marketing/privacy-policy" className="text-gray-400 text-xs hover:text-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-500 rounded px-1 transition-colors duration-300">
                    Privacy Policy
                  </Link>
                </li>
                <li>
          ...
          <div className="md:hidden space-y-6 divide-y divide-gray-700">
            ...
            {renderMobileSection('Customer Service', 'service', (
              <div className="space-y-2">
                {[
                  { label: 'Help Center', href: '/marketing/help' },
                  { label: 'Contact Us', href: '/marketing/contact' },
                  { label: 'FAQ', href: '/marketing/faq' },
                  { label: 'Shipping Info', href: '/marketing/shipping' },
                  { label: 'Returns & Refunds', href: '/marketing/returns' },
                ].map((item) => (
                  <Link
                    key={item.label}
                    href={item.href}
            ...
            {renderMobileSection('Legal', 'legal', (
              <div className="space-y-2">
                <Link href="/marketing/terms-of-service" className="block text-gray-400 text-sm hover:text-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-500 rounded px-1 transition-colors py-1">
                  Terms of Use
                </Link>
                <Link href="/marketing/privacy-policy" className="block text-gray-400 text-sm hover:text-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-500 rounded px-1 transition-colors py-1">
                  Privacy Policy
                </Link>
